...
"[project]/models/OtherBrokerage.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const OtherBrokerageSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    name: {
        type: String,
        required: true,
        trim: true
...
const OtherBrokerage = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["models"].OtherBrokerage || (0, __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["model"])("OtherBrokerage", OtherBrokerageSchema);
const __TURBOPACK__default__export__ = OtherBrokerage;
}),
"[project]/app/api/other-brokerages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$OtherBrokerage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/OtherBrokerage.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        if (filterStreet) query.street = {
            $regex: filterStreet,
            $options: "i"
        };
        if (filterCity) query.city = {
            $regex: filterCity,
            $options: "i"
        };
        if (filterProvince) query.province = {
            $regex: filterProvince,
            $options: "i"
        };
        if (filterPostalCode) query.postalCode = {
            $regex: filterPostalCode,
            $options: "i"
        };
        const sortObj = {};
        sortObj[sortField] = sortOrder === "asc" ? 1 : -1;
        const brokerages = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$OtherBrokerage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort(sortObj).lean();
...
async function POST(request) {
    try {
        ...
        const brokerage = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$OtherBrokerage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            brokerage
        }, {
            status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10mixy-._.js.map