...
async function GET(request, { params }) {
    try {
        ...
        const agent = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).lean();
        if (!agent) {
...
async function PUT(request, { params }) {
    try {
        ...
        const agent = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, body, {
            new: true,
            runValidators: true
        }).lean();
        if (!agent) {
...
async function DELETE(request, { params }) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const { id } = await params;
        const agent = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!agent) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Agent not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ohmkd2._.js.map