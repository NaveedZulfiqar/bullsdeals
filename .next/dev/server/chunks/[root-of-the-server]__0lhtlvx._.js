...
"[project]/models/Solicitor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const SolicitorSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    name: {
        type: String,
        required: true,
        trim: true
...
const Solicitor = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["models"].Solicitor || (0, __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["model"])("Solicitor", SolicitorSchema);
const __TURBOPACK__default__export__ = Solicitor;
}),
"[project]/app/api/solicitors/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Solicitor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Solicitor.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        const query = {};
        if (filterName) query.name = {
            $regex: filterName,
            $options: "i"
        };
        if (filterPhone) query.phone = {
            $regex: filterPhone,
            $options: "i"
        };
        if (filterCompanyName) query.companyName = {
            $regex: filterCompanyName,
            $options: "i"
        };
        if (filterFax) query.fax = {
            $regex: filterFax,
            $options: "i"
        };
        if (filterEmail) query.email = {
            $regex: filterEmail,
            $options: "i"
        };
        if (filterAddress) {
        ...
        const solicitors = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Solicitor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort(sortObj).lean();
...
async function POST(request) {
    try {
        ...
        const solicitor = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Solicitor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            solicitor
        }, {
            status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lhtlvx._.js.map