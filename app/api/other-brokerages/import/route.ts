...
export async function GET() {
  return csvSampleResponse("other_brokerages_import_sample.csv",
    ["Name", "Phone", "Email", "HST#", "Street", "City", "Province", "Postal Code", "Bank Name", "Institute #", "Transit #", "Account #"],
    ["Example Brokerage", "416-555-0100", "office@example.com", "", "123 Main St", "Toronto", "ONT", "M5V 1A1", "", "", "", ""]);
}
...
export async function POST(request: NextRequest) {
  try {
    const { OtherBrokerage } = await connectToDatabase();
